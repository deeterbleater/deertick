...
from bot.db.message import get_context, log_message, get_last_bot_message_in_channel
...
async def who_should_speak(message):
    ...
    last_message = await get_last_bot_message_in_channel(message.channel.id)
